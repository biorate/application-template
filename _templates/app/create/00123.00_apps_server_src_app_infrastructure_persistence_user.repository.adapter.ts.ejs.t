---
to: <%= h.server(!CUT_EXAMPLES && `${ROOT}/apps/${SERVER_NAME}/src/app/infrastructure/persistence/user.repository.adapter.ts`) %>
unless_exists: true
---
import { merge } from 'lodash';
import { Injectable } from '@nestjs/common';
import { User } from '@/app/domain';
import { UserNotExistsError, UserAlreadyExistsError } from '@/app/domain/error';
