---
to: <%= h.server(ADD_WEB_SOCKET && `${ROOT}/apps/${SERVER_NAME}/src/app/infrastructure/websocket/dto/debug/debug.dto.ts`) %>
unless_exists: true
---
import { IsEnum, IsString, IsObject } from 'class-validator';
import { Type } from 'class-transformer';
import { ApiProperty } from '@nestjs/swagger';
import { DebugEvents } from '@/app/infrastructure/websocket/events';
